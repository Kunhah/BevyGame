...
pub struct Buff {
    ...
    pub ends_in: u32, // every unit of duration will be equivalent of 60/16 seconds, that means everytime a the function to get the turn order is called, 60 >> 4 seconds passes and this will be decremented by 1
